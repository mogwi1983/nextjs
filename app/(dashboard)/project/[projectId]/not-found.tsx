    ...
    <div className="h-full p-4 sm:p-6 flex justify-center items-center">
      <div className="max-w-lg w-full text-center">
        <Image
          ...
          width={300}
          height={300}
          className="mx-auto mb-2 w-48 h-48 sm:w-64 sm:h-62 md:w-[270px] md:h-[270]"
        />
        <h1 className="text-2xl sm:text-3xl md:test-4xl font-bold text-secondary mb-3 sm:mb-4">
          Oops! Project Not Found
        </h1>
        <p className="text-base sm:text-lg md:text-x1 text-muted-foreground mb-6 sm:mb-8">
